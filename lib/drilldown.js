...
*/
(function (g) {
    "object" === typeof module && module.exports ? (g["default"] = g, module.exports = g) : "function" === typeof define && define.amd ? define("highcharts/modules/drilldown", ["highcharts"], function (n) {
        g(n);
        g.Highcharts = n;
        return g
    ...
    n(g, "modules/drilldown.src.js", [g["parts/Globals.js"], g["parts/Utilities.js"]], function (f, g) {
        var q = g.extend, n = g.objectEach, t = g.pick,
            C = g.syncTimeout, w = f.animObject, x = f.noop, y = f.color;
        g = f.defaultOptions;
        var D = f.format, p = f.Chart, r = f.seriesTypes, z = r.pie;
        r = r.column;
        var A = f.Tick, u = f.fireEvent, B = 1;
        q(g.lang, {drillUpText: "\u25c1 Back to {series.name}"});
        g.drilldown = {
        ...
        f.SVGRenderer.prototype.Element.prototype.fadeIn = function (a) {
            this.attr({
                opacity: .1,
                visibility: "inherit"
            }).animate({opacity: t(this.newOpacity, 1)}, a || {duration: 250})
        };
        ...
        p.prototype.addSingleSeriesAsDrilldown = function (a, b) {
            var c = a.series, d = c.xAxis, e = c.yAxis, h = [], l = [], k;
            var m = this.styledMode ? {colorIndex: t(a.colorIndex, c.colorIndex)} : {color: a.color || c.color};
            this.drilldownLevels || (this.drilldownLevels =
                []);
            var g = c.options ? (c.options._levelNumber || 0) : 0;
            (k = this.drilldownLevels[this.drilldownLevels.length - 1]) && k.levelNumber !== g && (k = void 0);
            b = q(q({_ddSeriesId: B++}, m), b);
            ...
            anotherA = q({
                    ...
                    pointIndex: n,
                    oldExtremes: {xMin: d && d.userMin, xMax: d && d.userMax, yMin: e && e.userMin, yMax: e && e.userMax},
                    resetZoomButton: this.resetZoomButton
                },
                m);
            this.drilldownLevels.push(anotherA);
            d && d.names && (d.names.length = 0);
            b = anotherA.lowerSeries = this.addSeries(b, !1);
        ...
        p.prototype.showDrillUpButton = function () {
            var a = this, b = this.getDrilldownBackText(), c = a.options.drilldown.drillUpButton, d;
        ...
        p.prototype.drillUp = function () {
            if (this.drilldownLevels && 0 !== this.drilldownLevels.length) {
                for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, d = b.length, e = a.series, h, l, k, m, f = function (b) {
                    ...
                    b.pop();
                    k = l.lowerSeries;
                    if (!k.chart) for (h = e.length; h--;) if (e[h].options.id === l.lowerSeriesOptions.id && e[h].options._levelNumber === c + 1) {
                        k = e[h];
                        break
                    }
                    k.xData = [];
                    l.levelSeriesOptions.forEach(f);
                    u(a, "drillup", {seriesOptions: l.seriesOptions});
                    m.type === k.type && (m.drilldownLevel = l, m.options.animation = a.options.drilldown.animation,
                    k.animateDrillupFrom && k.chart && k.animateDrillupFrom(l));
            ...
            (this.xAxis || []).forEach(function (a) {
                ...
                a.series.forEach(function (b) {
                    ...
                    for (c = 0; c < d.length; c++) {
                        ...
                        "number" !== typeof h && (h = b.pointClass.prototype.optionsToObject.call({series: b}, h), h.drilldown && (a.ddPoints[d[c]] || (a.ddPoints[d[c]] = []),
                            a.ddPoints[d[c]].push(e ? e[c] : !0)))
                    }
                });
            ...
            if (!a) {
                ...
                C(function () {
                    b.points && b.points.forEach(function (a, b) {
                        ...
                        e && !e.hidden &&
                        (e.fadeIn(), a.connector && a.connector.fadeIn())
                    })
        ...
        r.prototype.animateDrilldown = function (a) {
            var b = this, c = this.chart, d = c.drilldownLevels, e, h = w(c.options.drilldown.animation),
                f = this.xAxis, k = c.styledMode;
            a || (d.forEach(function (a) {
                ...
                var c = a.shapeArgs;
                k || (c.fill = a.color);
                a.graphic && a.graphic.attr(e).animate(q(a.shapeArgs, {fill: a.color || b.color}), h);
                a.dataLabel && a.dataLabel.fadeIn(h)
            }), this.animate = null)
        };
        r.prototype.animateDrillupFrom = function (a) {
            var b = w(this.chart.options.drilldown.animation), c = this.group, d = c !== this.chart.columnGroup,
                e = this;
            ...
            this.points.forEach(function (h) {
                var g = h.graphic, k = a.shapeArgs, m = function () {
                    g.destroy();
                    c && d && (c = c.destroy())
                };
                g && (delete h.graphic, e.chart.styledMode ||
                (k.fill = a.color), b.duration ? g.animate(k, f.merge(b, {complete: m})) : (g.attr(k), m()))
            })
        };
        z && q(z.prototype, {
            ...
            animateDrilldown: function (a) {
                var b = this.chart.drilldownLevels[this.chart.drilldownLevels.length - 1],
                    c = this.chart.options.drilldown.animation, d = b.shapeArgs, e = d.start,
                    h = (d.end - e) / this.points.length, g = this.chart.styledMode;
        ...
        f.Point.prototype.doDrilldown = function (a, b, c) {
            var d = this.series.chart, e = d.options.drilldown, h = (e.series || []).length;
            d.ddDupes || (d.ddDupes = []);
            for (; h-- && !f;) if (e.series[h].id === this.drilldown && -1 === d.ddDupes.indexOf(this.drilldown)) {
                var f = e.series[h];
        ...
        A.prototype.drillable = function () {
            var a = this.pos, b = this.label, c = this.axis, d = "xAxis" ===
                c.coll && c.getDDPoints, e = d && c.getDDPoints(a), h = c.chart.styledMode;
        ...
        f.addEvent(f.Series, "afterDrawDataLabels", function () {
            ...
            this.points.forEach(function (d) {
                var e = d.options.dataLabels, f = t(d.dlOptions, e && e.style, {});
                d.drilldown && d.dataLabel && ("contrast" !== a.color || c || (f.color = b.getContrast(d.color || this.color)),
                e && e.color && (f.color = e.color), d.dataLabel.addClass("highcharts-drilldown-data-label"), c || d.dataLabel.css(a).css(f))
            }, this)
        });
        ...
        f.addEvent(f.Point, "afterSetState", function () {
            ...
            this.drilldown && this.series.halo &&
            "hover" === this.state ? v(this.series.halo, "pointer", !0, a) : this.series.halo && v(this.series.halo, "auto", !1, a)
        })
    });
